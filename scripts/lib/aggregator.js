const { NAV_INITIAL_USD } = require('./runner');
...
function buildScenarioSummaryRow(scenario, regimeWindowEndIdx, regimeBrackets) {
    ...
    return {
        ...
        terminal_nav_index: scenario.terminalNavIndex,
        ...
        primary_threshold_lo: regimeBrackets.primary_lo,
        primary_threshold_hi: regimeBrackets.primary_hi,
        terminal_threshold_lo: regimeBrackets.terminal_lo,
        terminal_threshold_hi: regimeBrackets.terminal_hi,
...
function buildRegimeDescriptor(regimeDef, regimeFullWindowRows, peakIdxInFull, scenariosInRegime, bracketData) {
    ...
    return {
        ...
        btc_at_peak_given_1b_nav: 1_000_000_000 / peakPrice,
        ...
        primary_threshold_lo: bracketData.primary_lo,
        primary_threshold_hi: bracketData.primary_hi,
        terminal_threshold_lo: bracketData.terminal_lo,
        terminal_threshold_hi: bracketData.terminal_hi,
...
const SUMMARY_COLUMNS = [
    ...
    'terminal_date', 'terminal_bcr', 'terminal_nav_index', 'terminal_btc_held_index',
    ...
    'primary_threshold_lo', 'primary_threshold_hi',
    'terminal_threshold_lo', 'terminal_threshold_hi',
    'scenarios_total',
...
const DESCRIPTOR_COLUMNS = [
    'regime', 'label',
    'peak_date', 'peak_price_usd', 'btc_at_peak_given_1b_nav',
