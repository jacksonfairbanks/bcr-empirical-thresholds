 ...
 * fed_2022), computes the synthetic primary threshold using:
 ...
 *     surface_grid cells displayed in Figures 4 and 5
 *
 * Schema matches surface_validation.csv. Differs only in the calendar start
 * date convention: surface_grid_validation.csv (this file) is the §6.5.2 body
